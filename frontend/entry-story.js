(() => {
  ...
  styles.href='/static/entry-sequence.css?v=1';
  ...
  panel.querySelector('.story-copy').insertAdjacentHTML('beforebegin','<div class="story-image story-surveillance" aria-hidden="true"></div><div class="story-image story-protection" aria-hidden="true"></div>');
  hero.after(panel);
